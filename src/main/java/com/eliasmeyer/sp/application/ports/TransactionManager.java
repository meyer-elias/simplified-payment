 ...
 * automático</strong> em caso de exceção — sem necessidade de um método {@code rollback()}
 * explícito.
 *
 ...
 *
 * <p><strong>Nota de breaking change:</strong> A partir desta versão, o método foi simplificado
