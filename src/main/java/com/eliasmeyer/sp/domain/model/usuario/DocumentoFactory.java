 ...
 * <p>
 * Responsável por identificar o tipo de documento a partir do número e instanciar a classe
 * apropriada, evitando uso de instanceof.
 */
public class DocumentoFactory {
	...
	public static Documento criar(String numeroDocumento) {
		...
		final String digits = removeNonDigits(numeroDocumento);
		...
		return switch (digits.length()) {
			case CPF_LENGTH -> new Cpf(digits);
			case CNPJ_LENGTH -> new Cnpj(digits);
			default -> throw new IllegalArgumentException(
				String.format(
					"Documento inválido: deve ter %d (CPF) ou %d (CNPJ) dígitos, mas tem %d",
