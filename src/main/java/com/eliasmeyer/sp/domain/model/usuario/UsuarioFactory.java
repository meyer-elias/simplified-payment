 ...
 * <p>
 * Responsável por instanciar o tipo correto de usuário baseado
 * no tipo de documento, evitando uso de instanceof na aplicação.
 */
public class UsuarioFactory {
    ...
    public static Usuario criar(Documento documento, Nome nome, Email email, String senha) {
        ...
        throw new IllegalArgumentException("Tipo de documento inválido: " + documento.getClass().getSimpleName());
    }
}
