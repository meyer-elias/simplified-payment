package com.eliasmeyer.sp.core.domain.shared.identifier;
 ...
 * <p>
 * Encapsula um UUID gerado seguindo o padrão IdGenerator, garantindo que cada instância tenha um
...
public class Id extends GenericIdentifier<UUID> {
	...
	/**
	 * Reconstrói um identificador a partir de um UUID existente. Útil para persistência e
